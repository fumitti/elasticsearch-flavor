...
public class ElasticsearchPreloadDataModelTests extends ESTestCase {
    private final static Logger LOGGER = Logger.getLogger(ElasticsearchPreloadDataModelTests.class.getName());
